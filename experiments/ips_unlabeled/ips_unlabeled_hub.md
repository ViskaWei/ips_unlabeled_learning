...
**👣 下一步最有价值**
- 🔴 **P0**：**简化问题**：假设 V 已知，仅学习 Φ → 消除 V-Φ trade-off 的一半
- 🔴 **P0**：**理论分析**：弱形式 loss 的 identifiability 条件是什么？什么情况下有唯一解？
- 🟡 **P1**：考虑 **RKHS 正则化**（论文提到的 automatic kernel）→ 可能提供更好的 identifiability
- 🟡 **P1**：考虑 **多系统联合学习**：如果有多个不同 V 的系统共享 Φ，可能改善 identifiability
